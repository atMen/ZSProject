 ...
 * data：16/7/27
 */
public class XctGridImageAdapter extends
        RecyclerView.Adapter<XctGridImageAdapter.ViewHolder> {
    ...
    public XctGridImageAdapter(Context context, onAddPicClickListener mOnAddPicClickListener) {
