...
import customer.tcrj.com.zsproject.adapter.jdAdapter;
...
public class JdInfoActivity extends BaseActivity implements View.OnClickListener, BaseQuickAdapter.OnItemClickListener {
    ...
    private List<jdInfo.DataBean.ContentBean> beanList;
    private jdAdapter detailAdapter;
    ...
    private void initview() {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(JdInfoActivity.this));

        mRecyclerView.setAdapter(detailAdapter = new jdAdapter(beanList, JdInfoActivity.this));
                ...
                .enqueue(new GsonResponseHandler<jdInfo>() {
                    ...
                    public void onSuccess(int statusCode, jdInfo response) {
                        ...
                        if(response.getErrorcode().equals("9999")){
                            ...
                            Utils.toLogin(JdInfoActivity.this);
                        }
    ...
    private void loadMoreData(jdInfo response,boolean isError) {
        ...
        if (response == null) {
            ...
            if(pageNum > response.getData().getTotalPages()){//没有更多数据
                ...
                List<jdInfo.DataBean.ContentBean> content = response.getData().getContent();
                pageNum++;
    ...
    //下拉刷新
    private void loadData(List<jdInfo.DataBean.ContentBean> response,boolean isError) {
        ...
        if (response == null  || response.size() <= 0) {
            ...
            dlsmc = response.get(0).getAddress();
