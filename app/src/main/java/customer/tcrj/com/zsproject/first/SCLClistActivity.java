...
public class SCLClistActivity extends BaseActivity implements View.OnClickListener, BaseQuickAdapter.OnItemClickListener {
                ...
                .enqueue(new GsonResponseHandler<cpInfo>() {
                    ...
                    public void onSuccess(int statusCode, cpInfo response) {
                        ...
                        if(response.getErrorcode().equals("9999")){
                            ...
                            Utils.toLogin(SCLClistActivity.this);
                        }
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.btn_add:
                ...
                toClass(SCLClistActivity.this,AddCPinfoActivity.class);//产品信息录入
