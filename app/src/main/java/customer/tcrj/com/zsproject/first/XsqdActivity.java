...
import customer.tcrj.com.zsproject.adapter.qdAdapter;
...
public class XsqdActivity extends BaseActivity implements View.OnClickListener, BaseQuickAdapter.OnItemClickListener {
    ...
    private List<qdInfo.DataBean.ContentBean> beanList;
    private qdAdapter detailAdapter;
    ...
    private void initview() {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(XsqdActivity.this));

        mRecyclerView.setAdapter(detailAdapter = new qdAdapter(beanList, XsqdActivity.this));
    ...
    private void getData(final int num) {
        ...
        mMyOkhttp.post()
                .url(ApiConstants.xsqdApi)
                .jsonParams(jsonObject.toString())
                .enqueue(new GsonResponseHandler<qdInfo>() {
                    @Override
                    ...
                    @Override
                    public void onSuccess(int statusCode, qdInfo response) {
                        ...
                        if(response.getErrorcode().equals("9999")){
                            ...
                            Utils.toLogin(XsqdActivity.this);
                        }
    ...
    //上拉加载更多数据
    private void loadMoreData(qdInfo response,boolean isError) {
        ...
        if (response == null) {
            ...
            if(pageNum > response.getData().getTotalPages()){//没有更多数据
                ...
                List<qdInfo.DataBean.ContentBean> content = response.getData().getContent();
                pageNum++;
    ...
    //下拉刷新
    private void loadData(List<qdInfo.DataBean.ContentBean> response,boolean isError) {
    ...
    public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
        ...
        qdInfo.DataBean.ContentBean bean = (qdInfo.DataBean.ContentBean) adapter.getItem(position);
        dlsmc = bean.getQdmc();
        dlsid = bean.getId();
